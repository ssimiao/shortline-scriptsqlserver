...
create table TBUSER(
	IDUSER int Identity Not Null unique,
...
create table TBQUEUE(
	IDQUEUE INT IDENTITY NOT NULL UNIQUE,
...
create table TBRESERVES(
	IDRESERVE INT IDENTITY NOT NULL UNIQUE,
	IDUSER INT NOT NULL,
...
create table TBCOMPANY(
	IDCOMPANY INT IDENTITY NOT NULL UNIQUE,
...
ALTER TABLE TBRESERVES ADD CONSTRAINT SL_RESERVES_USER FOREIGN KEY (IDUSER) REFERENCES TBUSER (IDUSER);
ALTER TABLE TBRESERVES ADD CONSTRAINT SL_RESERVES_QUEUE FOREIGN KEY (IDQUEUE) REFERENCES TBQUEUE (IDQUEUE);
ALTER TABLE TBQUEUE ADD CONSTRAINT SL_QUEUE_COMPANY FOREIGN KEY (IDCOMPANY) REFERENCES TBCOMPANY (IDCOMPANY);
